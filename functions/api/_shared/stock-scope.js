...
export const SHARED_STOCK_MACHINE_LABEL = '总库存';
export const SHARED_STOCK_SOURCE_MACHINES = new Set(['1号机', '2号机', SHARED_STOCK_MACHINE_ID, SHARED_STOCK_MACHINE_LABEL, '1/2号机总库存']);
